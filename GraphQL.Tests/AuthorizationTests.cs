...
namespace GraphQL.Tests
{
    ...
    public class Query
    {
        public static int LastMessage([FromServices] IChat chatService)
            => chatService.Count;

        public static int AllMessages([FromServices] IChat chatService, string? from = null)
            => chatService.Count;
    ...
    {
        private GraphQLHttpMiddlewareOptions _options = new GraphQLHttpMiddlewareOptions();
        ...
        private TestServer CreateServer(Action<IServiceCollection>? configureServices = null)
        {
            ...
            {
                services.AddSingleton<Chat, Chat>();
